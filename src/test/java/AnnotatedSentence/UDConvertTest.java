...
public class UDConvertTest {
    ...
    public void testConvertUdPenn(){
        ...
        corpus.exportUniversalDependencyFormat(turkish,  "tr_penn-ud-train.conllu", "15");
        corpus = new AnnotatedCorpus(new File("../../Penn-Treebank/Turkish-Phrase/"), ".test");
        corpus.exportUniversalDependencyFormat(turkish, "tr_penn-ud-test.conllu", "15");
        corpus = new AnnotatedCorpus(new File("../../Penn-Treebank/Turkish-Phrase/"), ".dev");
        corpus.exportUniversalDependencyFormat(turkish, "tr_penn-ud-dev.conllu", "15");
        corpus = new AnnotatedCorpus(new File("../../Penn-Treebank-20/Turkish-Phrase/"), ".train");
        corpus.exportUniversalDependencyFormat(turkish, "tr_penn-ud-train.conllu", "20");
        corpus = new AnnotatedCorpus(new File("../../Penn-Treebank-20/Turkish-Phrase/"), ".test");
        corpus.exportUniversalDependencyFormat(turkish, "tr_penn-ud-test.conllu", "20");
    ...
    public void testConvertUdBoun(){
        ...
        corpus.exportUniversalDependencyFormat(turkish, "tr_boun-ud-test.conllu");
    ...
    public void testConvertUdImst(){
        ...
        corpus.exportUniversalDependencyFormat(turkish, "tr_imst-ud-test.conllu");
    ...
    public void testConvertUdImst2(){
        ...
        corpus.exportUniversalDependencyFormat(turkish, "tr_imst2-ud-test.conllu");
    ...
    public void testConvertUdTourism(){
        ...
        corpus.exportUniversalDependencyFormat(turkish, "tr_tourism-ud-train.conllu");
        corpus = new AnnotatedCorpus(new File("../../Etstur/Turkish-Phrase/"), ".train", 7750, 9999);
        corpus.exportUniversalDependencyFormat(turkish, "tr_tourism-ud-dev.conllu");
    ...
    public void testConvertUdKeNet(){
        ...
        corpus.combine(corpus2);
        corpus.exportUniversalDependencyFormat(turkish, "tr_kenet-ud-train.conllu");
        corpus = new AnnotatedCorpus(new File("../../Kenet-Examples/Turkish-Phrase/"), ".train", 7700, 9345);
        corpus.exportUniversalDependencyFormat(turkish, "tr_kenet-ud-dev.conllu");
    ...
    public void testConvertUdFramenet(){
        ...
        for (File file:listOfFiles) {
            if (file.isDirectory()){
                ...
                corpus.exportUniversalDependencyFormat(turkish, "tr_framenet-ud-train.conllu", fileName);
                corpus = new AnnotatedCorpus(new File("../../FrameNet-Examples/Turkish-Phrase/" + fileName), ".test");
                corpus.exportUniversalDependencyFormat(turkish, "tr_framenet-ud-test.conllu", fileName);
                corpus = new AnnotatedCorpus(new File("../../FrameNet-Examples/Turkish-Phrase/" + fileName), ".dev");
                corpus.exportUniversalDependencyFormat(turkish, "tr_framenet-ud-dev.conllu", fileName);
            }
        }
    }
